...
class PrixCarburantsDAO(metaclass=Singleton):
    def ajouter_prix_carburant(self, type_carburant_id, station_service_id, prix) -> bool:
       ...
       def supprimer_prix_carburant(self, type_carburant_id, station_service_id) -> bool:
    ...
    def prix_carburant_dans_station(self, id_type_carburant, id_stations) -> float:
